 ...
 * href='http://www.javaworld.com/javaworld/jw-12-2000/jw-1229-traps.html'> paper</a>}.
 * 
...
public class OSExec {
	/**
	 * Execute in a system dependent way. So make sure you give the appropriate command. I.e. don't try to 'ls' on a
	 * Windows system without such a command.
	 * 
	 * @param args
	 *            Command to be executed. Examples that work are given below. On Linux: "nedit -geometry 80x50-0+0" On
	 *            Windows: "\"D:\\Program Files\\Microsoft Office\\Office\\Winword.exe\""
	 * @return Exit status of the command. 0 usually means success. What is usually?
	 */
	...
	/**
	 * Self test; executes a simple "dir" command. If the command doesn't exist on the machine an error will be issued.
	 ...
	 *            in milliseconds.
	 * @return Exit status of the command. 0 usually means success. 1 for failure.
	 */
