 ...
 * as provided by the nih mgc.
 * 
 * This converter will interpret the fasta records to a java class: orf. Mostly
 * containing a changed identifier set.
 * @author Jurgen F. Doreleijers
 * @see <A HREF="ftp://ftp1.nci.nih.gov/pub/MGC/hs_mgc_cds_aa.fasta">example at nih mgc</a>
 */
public class FastaMGCConverter {
...
//    private String regexp_nucelotides_only;
    ...
    String MGC_DATABASE_IDENTIFIER      = "nih-mgc";   
    ...
    public FastaMGCConverter() {
        /** Using new regexp in standard java 1.4...
         */
        try {
            // Should match: ">BC055429 (translation) /nt_start=904 /aa_len=628"            
     ...
     *<PRE>
">BC055429 (translation) /nt_start=904 /aa_len=628"   
     </PRE>
    ...
    public boolean parseSummaryLine( String line ) {
        ...
        orfid.orf_db_name       = MGC_DATABASE_IDENTIFIER;        
    ...
    public static void main(String[] args) {
        ...
        General.showError( "Starting FastaMGCConverter.convert version 2");
        FastaMGCConverter c = new FastaMGCConverter();
        
        if ( testing ) {
            String line         = ">BC055429 (translation) /nt_start=904 /aa_len=628";
            ...
            if ( ! status ) {
                General.showError( "in FastaMGCConverter.convert.");
            }
        }
