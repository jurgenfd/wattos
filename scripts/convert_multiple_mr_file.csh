...
set dir_mr    = /share/wattos/mr_anno_backup_paper_2003-10-13
...
set dir_str   = /usr/home/jurgen/notpub_html/collab/CloneWars/mrfiles_30/all_2003_10_13
# Dir with scripts
set dir_scripts = /share/jurgen/Wattos/scripts
...
foreach x ( $list ) 
    echo "Doing $x"
    $dir_scripts/convert_mr_file.csh $dir_mr $dir_str $x $star_id
end
