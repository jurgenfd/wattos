...
public class UncompressInputStream extends FilterInputStream {
    ...
    static public void uncompress(String fileInName, FileOutputStream out)
            throws IOException {
        long start = System.currentTimeMillis();

        InputStream in = new UncompressInputStream(new FileInputStream(
                fileInName));
    ...
    public static void main(String args[]) throws Exception {
        ...
        while (true) {
            ...
            if (got < 0)
                break;
            // System.out.write(buf, 0, got); // doesn't work on my Windows box.
//            ArrayList al = PrimitiveArray.getLines(buf);
            // System.out.print(Strings.toString(al,true));
            tot += got;
        }
