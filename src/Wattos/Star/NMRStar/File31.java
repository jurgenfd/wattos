...
public class File31 {
    ...
    /**
     * Define varXXX for those tags that are actually going to be read from or writen to with a non-null value.
     */
    ...
    public boolean initConvenienceVariablesStar() {
        ...
        try {
            ...
            // tagNameEntryId = (String) ((ArrayList)starDict.toStar2D.get( "entry_main", "entry_id"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            // tagNameAssemblyEntry_ID = (String) ((ArrayList)starDict.toStar2D.get( "entry_main", "_Assembly.Entry_ID"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            // tagNameEntity_assemblyEntry_ID = (String) ((ArrayList)starDict.toStar2D.get( "mol_main",
            // "_Entity_assembly.Entry_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);

            // tagNameMolEntryId = (String) ((ArrayList)starDict.toStar2D.get( "mol_main", "entry_id"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            tagNameMolSFCategory = (String) ((ArrayList) starDict.toStar2D.get("mol_main", "_Entity.Sf_category"))
                    .get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameMolEntityId = (String) ((ArrayList)starDict.toStar2D.get( "mol_main", "_Entity.ID"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            // tagNameAtomSFId_1 = (String) ((ArrayList)starDict.toStar2D.get( "atom_main",
            // "_Conformer_family_coord_set.ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            tagNameDCtreeConstraintsID = (String) ((ArrayList) starDict.toStar2D.get("dc_main", "number"))
                    .get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCtreeID = (String) ((ArrayList)starDict.toStar2D.get( "dc_node",
            // "_Dist_constraint_tree.Constraints_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            // tagNameDCDistconstrainttreeID = (String) ((ArrayList)starDict.toStar2D.get( "dc_node", "number"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            tagNameDCTreenodemembernodeID = (String) ((ArrayList) starDict.toStar2D.get("dc_node", "number"))
                    .get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCContributionfractionalval = (String) ((ArrayList)starDict.toStar2D.get( "dc_node",
            ...
            tagNameDCAuthatomID = (String) ((ArrayList) starDict.toStar2D.get("dc_atom", "auth_atom_name"))
                    .get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCvalueConstraintsID = (String) ((ArrayList)starDict.toStar2D.get( "dc_node",
            // "_Dist_constraint_value.Constraints_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            // tagNameDCvalueWeight = (String) ((ArrayList)starDict.toStar2D.get( "dc_node", "peakWeight"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCvalueSpectralpeakppm1 = (String) ((ArrayList)starDict.toStar2D.get( "dc_node", "peakPpm1"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCvalueSpectralpeakppm2 = (String) ((ArrayList)starDict.toStar2D.get( "dc_node", "peakPpm2"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCcommentorgConstraintsID = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_comment_org.Constraints_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCcommentorgID = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_comment_org.ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCcommentorgCommentbeginline = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_comment_org.Comment_begin_line" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCcommentorgCommentbegincolumn = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_comment_org.Comment_begin_column" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCcommentorgCommentendline = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_comment_org.Comment_end_line" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCcommentorgCommentendcolumn = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_comment_org.Comment_end_column" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCcommentorgComment = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_comment_org.Comment" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCparsefileConstraintsID = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_parse_file.Constraints_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCparsefileID = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_parse_file.ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCparsefileName = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_parse_file.Name" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCparsefileconverrConstraintsID = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_parse_file_conv_err.Constraints_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCparsefileconverrID = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_parse_file_conv_err.ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCparsefileconverrParsefileID = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_parse_file_conv_err.Parse_file_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCparsefileconverrParsefilesflabel = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_parse_file_conv_err.Parse_file_sf_label" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCparsefileconverrParsefileconstraintID = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_parse_file_conv_err.Parse_file_constraint_ID"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCparsefileconverrConverrortype = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_parse_file_conv_err.Conv_error_type" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameDCparsefileconverrConverrornote = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Dist_constraint_parse_file_conv_err.Conv_error_note" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            // tagNameCDIH_ID1 = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Torsion_angle_constraint_list.ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            // tagNameCDIH_Program = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Torsion_angle_constraints.Program" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameCDIH_Type = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Torsion_angle_constraints.Type" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameCDIH_Subtype = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Torsion_angle_constraints.Subtype" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameCDIH_Format = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_Torsion_angle_constraints.Format" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameCDIH_Constraints_ID = (String) ((ArrayList)starDict.toStar2D.get( "cdih_main" ,
            // "_Torsion_angle_constraint.Constraints_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            tagNameCDIH_Angle_lower_bound_val = (String) ((ArrayList) starDict.toStar2D.get("cdih_atom", "lowBound"))
                    .get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameCDIH_Force_constant_value = (String) ((ArrayList)starDict.toStar2D.get( "cdih_atom" ,
            // "forceConstant" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameCDIH_Potential_function_exponent = (String) ((ArrayList)starDict.toStar2D.get( "cdih_atom" ,
            // "potentialFunction" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            // tagNameRDC_ID1 = (String) ((ArrayList)starDict.toStar2D.get( "unknown", "_RDC_constraint_list.ID"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            // tagNameRDC_Program = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_RDC_constraint_list.Program" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameRDC_Type = (String) ((ArrayList)starDict.toStar2D.get( "unknown", "_RDC_constraint_list.Type"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameRDC_Subtype = (String) ((ArrayList)starDict.toStar2D.get( "unknown",
            // "_RDC_constraint_list.Subtype" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameRDC_Format = (String) ((ArrayList)starDict.toStar2D.get( "unknown", "_RDC_constraint_list.Format"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameRDC_Constraints_ID = (String) ((ArrayList)starDict.toStar2D.get( "rdc_main" ,
            // "_RDC_constraint.Constraints_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            // tagNameStudy_listEntry_ID = (String) ((ArrayList)starDict.toStar2D.get( "entry_main" ,
            // "_Study_list.Entry_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameStudy_listID = (String) ((ArrayList)starDict.toStar2D.get( "entry_main" , "_Study_list.ID"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            ...
            tagNameStudyDetails = (String) ((ArrayList) starDict.toStar2D.get("entry_main", "_Study.Details"))
                    .get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameStudyEntry_ID = (String) ((ArrayList)starDict.toStar2D.get( "entry_main" , "_Study.Entry_ID"
            // )).get(StarDictionary.POSITION_STAR_TAG_NAME);
            // tagNameStudyStudy_list_ID = (String) ((ArrayList)starDict.toStar2D.get( "entry_main" ,
            // "_Study.Study_list_ID" )).get(StarDictionary.POSITION_STAR_TAG_NAME);
    ...
    /**
     * BEGIN BLOCK FOR SETTING NMR-STAR CONVENIENCE VARIABLES COPY FROM Wattos.Star.NMRStar.File31 Will return true if
     * tree with actual restraints was found.
     */
    boolean initConvenienceVariablesStarWattosDC(SaveFrame sFDC) {
        ...
        varDCTreenodemembernodeID == null
                ...
                ||
                // varDCvalueSpectralpeakID == null || not all of them are needed and should be commented out like this
                // one.
    ...
    private boolean initConvenienceVariablesStarWattosCDIH(SaveFrame sFCDIH) {
        ...
        /*
         * tTPar1 = sFCDIH.getTagTable(tagNameCDIHparsefileConstraintsID, true); if ( tTPar1 == null ) {
         * ;//General.showDebug("Failed to get parsed file info tT 1 by tag name:" + tagNameCDIHparsefileConstraintsID
         * ); } tTPar2 = sFCDIH.getTagTable(tagNameCDIHparsefileconverrConstraintsID, true); if ( tTPar2 == null ) {
         * ;//General.showDebug("Failed to get parsed file info tT 2 by tag name:" +
        ...
        if (varCDIH_Sf_category == null
                ...
                // varCDIH_ID1 == null ||
                /**
                 * varCDIHMRfileblockposition == null || varCDIHProgram == null || varCDIHType == null || varCDIHSubtype
                 * == null || varCDIHFormat == null ||
                 */
    ...
    private boolean initConvenienceVariablesStarWattosRDC(SaveFrame sFRDC) {
        ...
        /*
         * tTPar1 = sFRDC.getTagTable(tagNameRDCparsefileConstraintsID, true); if ( tTPar1 == null ) {
         * ;//General.showDebug("Failed to get parsed file info tT 1 by tag name:" + tagNameRDCparsefileConstraintsID );
         * } tTPar2 = sFRDC.getTagTable(tagNameRDCparsefileconverrConstraintsID, true); if ( tTPar2 == null ) {
         * ;//General.showDebug("Failed to get parsed file info tT 2 by tag name:" +
        ...
        if (varRDC_Sf_category == null
                ...
                // varRDC_ID1 == null ||
                /**
                 * varRDCMRfileblockposition == null || varRDCProgram == null || varRDCType == null || varRDCSubtype ==
                 * null || varRDCFormat == null ||
                 */
     ...
     *            used to link atoms when this parameter is set.
     * @param matchRestraints2SoupByDefaultDetails
     *            Try to link the atoms in restraints to the molecules in the soup.
     * @param url
     * @param doEntry
     *            Absorb the molecular system description and the coordinates into Wattos.
     * @param doRestraints
     *            Absorb the restraints.
     * @param removeUnlinkedRestraints
     *            After possibly matching the atoms in the restraints to the soup remove any that have unmatched atoms.
     * @param syncModels
     *            Remove any unsynced atoms. Ie atoms that are not present in all models.
     */
    public boolean toWattos(URL url, boolean doEntry, boolean doRestraints,
        ...
        /**
         * Get file characteristics ArrayList tTList = db.getTagTableList( StarGeneral.WILDCARD, "file_characteristics",
         * StarGeneral.WILDCARD, StarGeneral.WILDCARD); if ( tTList == null ) { General.showWarning(
         * "Failed to find saveframe of category: file_characteristics. Not setting database and db id."); } else if (
         * tTList.size() != 1 ) {
         * General.showWarning("Found number of saveframes of category: file_characteristics not 1 but: " +
         * tTList.size() + " Not setting database and db id."); } else { OrfId orfId = new OrfId(); TagTable tT =
         * (TagTable) tTList.get(0); orfId.orf_db_id = tT.getColumn( starDict.toStar2D.get( ); }
         */
        ...
        if (doEntry) {
             ...
             * 1ai0 1 9 . 1 $R6_INSULIN_HEXAMER I . 1ai0 1 10 . 2 $R6_INSULIN_HEXAMER_2 J . 1ai0 1 11 . 1
            ...
            for (int modelCount = 1; modelCount <= modelCountMax; modelCount++) {
                ...
                for (int molCount = 1; molCount <= molCountMax; molCount++) {
                    ...
                    // SaveFrame sFRes = SaveFrame.selectSaveFrameByTagNameAndFreeValue( sfEntityList,
                    ...
                    /**
                     * Not encouraged to use TagTable tTRes = sFRes.getTagTable(tagNameResResId, false);
                     */
            ...
            // XXX mark of ATOMS
            /**
             * _Atom_site.Model_ID _Atom_site.ID _Atom_site.Label_entity_assembly_ID _Atom_site.Label_entity_ID
             * _Atom_site.Label_comp_index_ID _Atom_site.Label_comp_ID _Atom_site.Label_atom_ID _Atom_site.Type_symbol
             * _Atom_site.Cartn_x _Atom_site.Cartn_y _Atom_site.Cartn_z _Atom_site.Occupancy _Atom_site.Auth_asym_ID
             * _Atom_site.Auth_seq_ID _Atom_site.Auth_comp_ID _Atom_site.Auth_atom_ID _Atom_site.Entry_ID
             * _Atom_site.Conformer_family_coord_set_ID 1 1 1 1 1 GLY N N 3.445 18.796 -24.642 0.0 A 1 GLY N 1ai0 1 1 2
             * 1 1 1 GLY CA C 3.375 18.022 -25.915 0.0 A 1 GLY CA 1ai0 1 ... 2 9601 21 5 1 HOH H2 H 0.862 -2.010 -23.901
             * 0.0 . 9 HOH H2 1ai0 1 2 9602 21 5 2 HOH O O 0.272 -1.726 -3.829 0.0 . 10 HOH O 1ai0 1 2 9603 21 5 2 HOH
             * H1 H 0.698 -1.088 -3.255 0.0 . 10 HOH H1 1ai0 1 2 9604 21 5 2 HOH H2 H 0.960 -2.359 -4.041 0.0 . 10 HOH
             * H2 1ai0 1
             */
            if (sfCoor != null) { // Make just one model without atoms if there're no coordinates.
                ...
                /**
                 * Strategy will be to add columns to the original table in STAR and then copy the complete set to the
                 * dbms main table for atoms. The copy can be batched and will be faster than copy one by one row.
                 */
        ...
        if (matchRestraints2SoupByDefaultDetails || matchRestraints2SoupByAuthorDetails) {
            /**
             * The map has the following keys in order: mol number, res number, atom name which ar key to an Integer
             * representing the atom rid of the first model.
             */
        ...
        if (sfDCList == null) {
            ...
            for (int dcCountList = 1; dcCountList <= dcCountListTotal; dcCountList++) {
                ...
                // SaveFrame sFDC = SaveFrame.selectSaveFrameByTagNameAndFreeValue( sfDCList, tagNameDCID, new
                // Integer(dcCountList));
                ...
                /**
                 * The following algorithm assumes that the rows in the 3 tables are sorted by constraint number, tree
                 * node, and member id. It will check but on violation of the assumption return false from this routine.
                 */
                ...
                while (starDCTreeRId < tTTree.sizeRows) { // scan the whole tree tagtable.
                    ...
                    if (logicalOperationString != varDCtreeLogicoperation[starDCTreeRId]) { // fast equality op possible
                        ...
                        if (logicalOperationInteger != null) {
                            ...
                            // DistConstr.DEFAULT_LOGICAL_OPERATION_NAMES[ logicalOperationInt ]);
                        } else {
                    ...
                    if (Defs.isNull(logicalOperationInt)) {
                        ...
                        while (starDCAtomRid < tTAtom.sizeRows) {
                            ...
                            // dc.contribution[ currentDCNodeId] = varDCContributionfractionalval[ starDCAtomRid ]; //to
                            ...
                            if (matchRestraints2SoupByDefaultDetails) {
                                ...
                                // General.showDebug("Looking for mol: " + molId + " res: " + resNumb + " atom: " +
                                // atomName);
                                ...
                                if (atomRID == null) {
                                    ...
                                    if (atomSet == null || atomSet.isEmpty()) {
                                        ...
                                        ArrayList list = (ArrayList) ui.wattosLib.pseudoLib.toAtoms.get(resName,
                                                atomName); // Query with key of presumed pseudo atom.
                                ...
                                if (atomRID == null) {
                                    ...
                                    if (atomFound) {
                                        ArrayList list = (ArrayList) ui.wattosLib.pseudoLib.toAtoms.get(resName,
                                                atomNameAuthorTranslated); // Query with key of presumed pseudo atom.
                                        if (list == null || list.size() < 1) {
                                            General
                                                    .showDetail("While reading DCs: While reading DCs: Coulnd't find atom (assumed a pseudo but apparently not) in residue: "
                                                            + resNumb
                            ...
                            for (int at_no = 0; at_no < equiAtomList.size(); at_no++) {
                                ...
                                // if ( Defs.isNull( atomRIDint ) ) { // store the original values in stead of the
                                // reference.
                                ...
                                // dc.resNameList[ currentDCAtomId ] = dc.resNameListNR.intern(varDCLabelcompID[
                                // starDCAtomRid] );
                                // dc.atomNameList[ currentDCAtomId ] = dc.atomNameListNR.intern(varDCLabelatomID[
                                // starDCAtomRid] );
        ...
        if (sfSCList == null) {
            ...
            for (int scCountList = 1; scCountList <= scCountListTotal; scCountList++) {
                ...
                // Collect unique unlinked atoms to show as a warning later on
                HashOfHashesOfHashes unlinkedAtoms = new HashOfHashesOfHashes();
                // SaveFrame sFSC = SaveFrame.selectSaveFrameByTagNameAndFreeValue( sfSCList, tagNameCDIH_ID1, new
                // Integer(scCountList));
                ...
                /**
                 * Scan all the tagtables for the column with the distance list ids and make sure that all are the same
                 * as assumed. This can be done more efficiently by a scan than by a sort. Optimalization todo if
                 * needed.
                 */
                ...
                // General.showError("scCountList id should have been: " + scCountList +
...
//                            + Math.toDegrees(sc.uppBound[currentSCId]));
                    ...
                    for (int atomId = 0; atomId < varAtomXLol.length; atomId++) {
                        ...
                        if (var_StarAuth_segment_code_x == null) {
                            // sc.authMolNameList[ currentSCAtomId ] = sc.authMolNameListNR.intern(
                            // var_StarAuth_segment_code_x[ starSCMainId] );
                            // sc.authResIdList[ currentSCAtomId ] = sc.authResIdListNR.intern( var_StarAuth_seq_ID_x[
                            // starSCMainId] );
                            // sc.authResNameList[ currentSCAtomId ] = sc.authResNameListNR.intern(
                            // var_StarAuth_comp_ID_x[ starSCMainId] );
                            // sc.authAtomNameList[currentSCAtomId ] =
                            // sc.authAtomNameListNR.intern(var_StarAuth_atom_ID_x[ starSCMainId] );
                        } else {
    ...
    /**
     * Convert the data in Wattos in components in the gumbo etc. General strategy is: -1- for each entry ask for a file
     ...
     * selected no Molecular System Description (MSD) is written. If at least one is selected (even if it's not in the
     * same entry) the whole entry's MSD is written.
    ...
    public SaveFrame getSFTemplateAssembly() {
        ...
        try {
             ...
             * _Entity_assembly.ID _Entity_assembly.Entity_assembly_name _Entity_assembly.Entity_ID
             * _Entity_assembly.Entity_label _Entity_assembly.Asym_ID _Entity_assembly.Details _Entity_assembly.Entry_ID
             * _Entity_assembly.Assembly_ID 1 "MONOCYTE CHEMOATTRACTANT PROTEIN-3" 1 $MONOCYTE_CHEMOATTRACTANT_PROTEIN-3
             * . . 1 1
             */
            ...
            tT.isFree = false;
            /**
             * _PDBX_nonpoly_scheme.Entity_assembly_ID EntityAssemblyID INTEGER no no yes _PDBX_nonpoly_scheme.Entity_ID
             * EntityID INTEGER no no no _PDBX_nonpoly_scheme.Mon_ID MonID CHAR(12) no no no
             * _PDBX_nonpoly_scheme.Comp_index_ID # should start at one so from _pdbx_nonpoly_scheme.ndb_seq_num
             * _PDBX_nonpoly_scheme.Comp_ID _PDBX_nonpoly_scheme.Auth_seq_num _pdbx_nonpoly_scheme.auth_seq_num
             */
    ...
    /**
     * This method does the actual work. Assumes that items in the DBMS are all in one entry. It will take only the
    ...
    private DataBlock toSTARDataBlock(boolean usePostFixedOrdinalsAtomName) {
        ...
        // ASSEMBLY
        /**
         * _Assembly.Sf_category assembly _Assembly.ID 1 _Assembly.Name 1bo0 _Assembly.Entry_ID 1
         * _Assembly.Number_of_components 1 _Assembly.Organic_ligands 0 _Assembly.Metal_ions 0 _Assembly.Paramagnetic no
         * _Assembly.Thiol_state "all free" _Assembly.Molecular_mass 9373.9151
         */
        ...
        for (molRID = molSet.nextSetBit(0); molRID >= 0; molRID = molSet.nextSetBit(molRID + 1)) {
            ...
            // tTAssemblyEntity.setValue( entityRID, tagNameEntity_assemblyAsym_ID, mol.asymId[entityRID]); # was a bug?
        ...
        for (molRID = molSet.nextSetBit(0); molRID >= 0; molRID = molSet.nextSetBit(molRID + 1)) {
            ...
            for (resRID = resSet.nextSetBit(0); resRID >= 0; resRID = resSet.nextSetBit(resRID + 1)) {
                ...
                tTAssemblyPDBX_nonpoly_scheme.setValue(entityRID, tagNamePDBX_nonpoly_schemeComp_ID,
                        res.nameList[resRID]);
                // tTAssemblyPDBX_nonpoly_scheme.setValue( entityRID, tagNamePDBX_nonpoly_schemeAuth_seq_num,
        ...
        if (dcListCountTotal < 1) {
            ...
            for (int currentDCListDCId = dcSetDistinctList.nextSetBit(0); currentDCListDCId >= 0; currentDCListDCId = dcSetDistinctList
                ...
                for (int d = 0; d < map.length; d++) {
                    ...
                    // General.showDebug("Found the following rids of nodes in constraint: " + PrimitiveArray.toString(
                    // dcNodes ));
                    if (dcNodes == null) {
                    ...
                    for (int currentDCNodeBatchId = 0; currentDCNodeBatchId < dcNodes.size(); currentDCNodeBatchId++) {
                        ...
                        // General.showDebug("Preparing node: " + dCNodeNumber + " at rid: " + currentDCNodeId +
                        ...
                        // currentDCNodeId + "): " + PrimitiveArray.toString( dcMembs ));
                        if (dcMembs.size() != 2) {
                            General
                        ...
                        for (int currentDCMembBatchId = 0; currentDCMembBatchId < dcMembs.size(); currentDCMembBatchId++) {
                            ...
                            // General.showDebug("Found the following rids of atoms in constraint node (" + dCNodeNumber
                            ...
                            for (int currentDCAtomBatchId = 0; currentDCAtomBatchId < dcAtoms.size(); currentDCAtomBatchId++) {
                                ...
                                // Check if the relation grew in size because not all relations can be adaquately
                                // estimated.
                                ...
                                if (atomFound) {
                                    ...
                                    if (molNum != prevMolNum) {
                                        entityNum = ((Integer) molNumber2EntityNumberMap.get(new Integer(molNum)))
                                                .intValue(); // expensive so only do when changes are possible.
                                    }
        ...
        if (atomRID < 0) {
            ...
            if (atomCount > 0) {
                ...
                tTCoor.insertColumn(tagNameAtomModelId, Relation.DATA_TYPE_INT, null)
                        ...
                        &
                        // tTCoor.insertColumn(tagNameAtomId, Relation.DATA_TYPE_INT, null)& // already done by regular
                        // number
                ...
                // General.showDebug("Keeping columns ["+columnListToKeep.size()+"[: " + Strings.toString(
                // columnListToKeep));
    ...
    /**
     * Based on full sequence (not the 1 character ids) of the given selection of moleculse, determine the different
     * entities and map the molecules to them. The returned map has keys for the molecule RID and values for the entity
     * numbers. Molecules without any residues are considered to be derived from the same entity.
     */
    ...
    /**
     * Create a map to be used in the coordinate table. It maps molecule numbers to entity numbers which if all models
     * are the same this is correct.
     */
    ...
    /**
     * Copy the residue id (not the sequence number) and name from the residue table to the atom table.
     */
    ...
    /**
     * Adds the .Entry_ID and .ID tags to the first tt (tag table) in each sf (save frame) and .Entry_ID and .XXXX_ID
     * tags to any further tts in each sf. Keeps track of the ids of some sf category instances as they appear in
