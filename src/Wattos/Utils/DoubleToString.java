...
/** Taken from "Java Performance Tuning" By Jack Shirazi
*/

import java.text.*;

/** Fast method for converting <CODE>double</CODE> to <CODE>String</CODE> */
public class DoubleToString
{
  //Hard code some byte arrays to make them quickly available
...
//  int NumDigits = 4;
  ...
  General.showOutput("The " + name);
  General.showOutput("    " + list);
  General.showOutput("are appended to a StringBuffer one by one " + repeat + " times.");
  s = new StringBuffer();
  Runtime.getRuntime().gc();

  General.showOutput("Starting test");
  time1 = System.currentTimeMillis();
  for (int i = repeat; i > 0; i--)
    for (int j = arr.length-1; j >= 0; j--)
      a.append(s,arr[j]);
  time1 = System.currentTimeMillis() - time1;
  General.showOutput("  The append        took " + time1 + " milliseconds");
  s = new StringBuffer();
  Runtime.getRuntime().gc();
  ...
  time1 = System.currentTimeMillis() - time1;
  General.showOutput("  The format append took " + time1 + " milliseconds");
  s = new StringBuffer();
  Runtime.getRuntime().gc();
  ...
  General.showOutput("  The StringBuffer  took " + time2 + " milliseconds");
  s = new StringBuffer();
  Runtime.getRuntime().gc();
  ...
  time2 = System.currentTimeMillis() - time2;
  General.showOutput("  The DecimalFormat  took " + time2 + " milliseconds");
  s = new StringBuffer();
  Runtime.getRuntime().gc();
