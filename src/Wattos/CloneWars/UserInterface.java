...
import java.io.*;
import java.util.*;
import Wattos.CloneWars.WattosMenu.*;
...
public class UserInterface implements Serializable, ActionListener {
     ...
     * 
     * */
    public static String WATTOS_VERSION="20070803-1449";
...
//        General.showOutput("debugging 0");
        ...
        if ( ! sp.containsKey("WATTOSROOT") ) {
            General.showWarning("The shell variable WATTOSROOT isn't defined.");
            General.showWarning("Consider defining it to be the directory of your Wattos installation.");
            return true;
        }
        String wattosRootDirStr = sp.getProperty( "WATTOSROOT" );
        wattosRootDir = new File(wattosRootDirStr);
        General.showOutput("Setting wattosRootDir to: " + wattosRootDir);
...
//            ui.gui = null; // is already done when leaving the doGuiMain method.
        ...
        General.showOutput("Wattos ["+WATTOS_VERSION+"] at: " + Wattos.Utils.Dates.getDate( ui.startTime ));
