...
public class UserInterface implements Serializable, ActionListener {
     ...
     * 
     * */
    public static String WATTOS_VERSION="${wattos_version}";
...
//        General.showWarning("Remove next statement after debugging is done");
...
//        General.showOutput("sp: " + Strings.toString(sp));
        ...
        wattosRootDir = new File(sp.getProperty( "WATTOSROOT" ));
